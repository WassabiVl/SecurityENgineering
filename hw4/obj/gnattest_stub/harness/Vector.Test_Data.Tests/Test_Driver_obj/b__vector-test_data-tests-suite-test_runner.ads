...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_vector__test_data__tests__suite__test_runner" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#48bd2ce8#;
   pragma Export (C, u00001, "vector__test_data__tests__suite__test_runnerB");
   ...
   u00161 : constant Version_32 := 16#33489ddc#;
   pragma Export (C, u00161, "gnattest_generatedS");
   u00162 : constant Version_32 := 16#588a136a#;
   pragma Export (C, u00162, "vector__test_data__tests__suiteB");
   u00163 : constant Version_32 := 16#1c5dd51b#;
   pragma Export (C, u00163, "vector__test_data__tests__suiteS");
   ...
   u00168 : constant Version_32 := 16#2dabbd0c#;
   pragma Export (C, u00168, "vector__test_data__testsB");
   u00169 : constant Version_32 := 16#3853c6a0#;
   pragma Export (C, u00169, "vector__test_data__testsS");
   u00170 : constant Version_32 := 16#52f1910f#;
   pragma Export (C, u00170, "system__assertionsB");
   u00171 : constant Version_32 := 16#ff2dadac#;
   ...
   u00177 : constant Version_32 := 16#03e83d1c#;
   pragma Export (C, u00177, "ada__numerics__elementary_functionsB");
   u00178 : constant Version_32 := 16#edc89b7f#;
   pragma Export (C, u00178, "ada__numerics__elementary_functionsS");
   ...
   u00185 : constant Version_32 := 16#6ad59d2c#;
   ...
   --  vector.test_data%s
   --  vector.test_data%b
   --  vector.test_data.tests%s
   --  vector.test_data.tests%b
   --  vector.test_data.tests.suite%s
   --  vector.test_data.tests.suite%b
   --  vector.test_data.tests.suite.test_runner%b
