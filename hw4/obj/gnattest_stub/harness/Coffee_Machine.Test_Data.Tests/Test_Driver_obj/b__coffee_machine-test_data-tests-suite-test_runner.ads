...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_coffee_machine__test_data__tests__suite__test_runner" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#73561378#;
   pragma Export (C, u00001, "coffee_machine__test_data__tests__suite__test_runnerB");
   ...
   u00161 : constant Version_32 := 16#2e39e81c#;
   pragma Export (C, u00161, "coffee_machine__test_data__tests__suiteB");
   u00162 : constant Version_32 := 16#3b0b6564#;
   pragma Export (C, u00162, "coffee_machine__test_data__tests__suiteS");
   ...
   u00167 : constant Version_32 := 16#c2ddd778#;
   pragma Export (C, u00167, "coffee_machine__test_data__testsB");
   u00168 : constant Version_32 := 16#203c2eb5#;
   pragma Export (C, u00168, "coffee_machine__test_data__testsS");
   u00169 : constant Version_32 := 16#1af66c52#;
   pragma Export (C, u00169, "coffee_machine__test_dataB");
   u00170 : constant Version_32 := 16#5721d985#;
   pragma Export (C, u00170, "coffee_machine__test_dataS");
   u00171 : constant Version_32 := 16#7fe3645f#;
   pragma Export (C, u00171, "coffee_machineB");
   u00172 : constant Version_32 := 16#be20c6e8#;
   pragma Export (C, u00172, "coffee_machineS");
   ...
   u00175 : constant Version_32 := 16#33489ddc#;
   pragma Export (C, u00175, "gnattest_generatedS");
   ...
   --  coffee_machine%s
   --  coffee_machine%b
   --  coffee_machine.test_data%s
   --  coffee_machine.test_data%b
   --  gnattest_generated%s
   --  coffee_machine.test_data.tests%s
   --  coffee_machine.test_data.tests%b
   --  coffee_machine.test_data.tests.suite%s
   --  coffee_machine.test_data.tests.suite%b
   --  coffee_machine.test_data.tests.suite.test_runner%b
